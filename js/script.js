...
function setTheme() {
  if (localStorage.length === 0 || localStorage.getItem(THEME_KEY) === DARK_THEME) {
...
function toggleTheme() {
  ...
  localStorage.setItem('JARY_THEME', `${document.body.className === LIGHT_THEME ? LIGHT_THEME : DARK_THEME}`)
}
